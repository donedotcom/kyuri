...
*/
var _mapAsync = function (ar, fn, callback) {
...
exports.run = function (features, steps, callback) {
  _mapAsync(features, function (feature, featureCb) {
    var feature = feature[Object.keys(feature).shift()];
    _mapAsync(feature.scenarios, function (scenario, scenarioCb) {
      if (scenario.outline) {
        scenarioCb();
      } else {
        _mapAsync(scenario.breakdown, function(step, stepCb) {
